...
public class CameraController : MonoBehaviour
{
    ...
    public float distanciaInicial = 12f; //distancia inicial de la cámara al jugador
    public float distanciaActual; //distancia actual de la cámara al jugador

    public float zoomMinimo = 8f; //zoom mínimo permitido
    public float zoomMaximo = 14f; //zoom máximo permitido
